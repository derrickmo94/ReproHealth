package com.example.hericxon.reprohealth.Relationships;
...
public class RelationshipActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ActionBarDrawerToggle toggle;
    Toolbar toolbar;
    DrawerLayout drawer;
    NavigationView navigationView;
    Button detailsbtn,friendsbtn,keysbtn,parentsbtn,signsbtn,specialbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailsbtn = findViewById(R.id.button_details);
        friendsbtn = findViewById(R.id.button_friends);
        keysbtn = findViewById(R.id.button_keys);
        parentsbtn = findViewById(R.id.button_parents);
        signsbtn = findViewById(R.id.button_signs);
        specialbtn = findViewById(R.id.button_special);

        detailsbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent details;
                details = new Intent(RelationshipActivity.this,RelaionshipDetails.class);
                details.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        friendsbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent friend;
               friend = new Intent(RelationshipActivity.this,RelationshipFriends.class);
               friend.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        ...
        keysbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent key;
                key = new Intent(RelationshipActivity.this,RelationshipKey.class);
     ...
     parentsbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent parent;
                parent = new Intent(RelationshipActivity.this,RelationshipParents.class);
               parent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(parent);
            }
        });

        signsbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sign;
                sign = new Intent(RelationshipActivity.this,RelationshipSigns.class);
        ...
        specialbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent special;
               special = new Intent(RelationshipActivity.this,RelationshipSpecial.class);
                special.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

...
public class HivImmuneAttack extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    DrawerLayout drawer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hiv__immune_attack);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            case R.id.nav_home:
                Intent home = new Intent(this, com.example.hericxon.reprohealth.home.MainMenu.class);

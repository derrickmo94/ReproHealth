...
public class Emotions extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ActionBarDrawerToggle toggle;
    Toolbar toolbar;
    DrawerLayout drawer;
    NavigationView navigationView;
    Button adolescence_btn,psychological_dev_btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adolescence_btn = findViewById(R.id.adolescence_challenges_btn);
        psychological_dev_btn = findViewById(R.id.psychological_btn);
        ...
        adolescence_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent adolescence_challenges;
                adolescence_challenges = new Intent(Emotions.this,AdolescenceChalleges.class);
                adolescence_challenges.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(adolescence_challenges);
            }
        });

        psychological_dev_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent psychological;
                psychological = new Intent(Emotions.this,PsychologicalDevelopment.class);
                psychological.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(psychological);
            }
        });
    }

...
public class RelationshipFriends extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relationship_friends);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            ...
            logged_user.slogOut();
            overridePendingTransition(R.anim.onbackpressed_outgoing,R.anim.onbackpressed_incoming);
            return true;
